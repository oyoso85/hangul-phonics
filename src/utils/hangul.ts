...
// 기초 발음: 자음 음가 매핑 (자모 이름이 아닌 음가)
export const CONSONANT_PHONEMES: Record<string, string> = {
  'ㄱ': '그', 'ㄴ': '느', 'ㄷ': '드', 'ㄹ': '르', 'ㅁ': '므', 'ㅂ': '브',
  'ㅅ': '스', 'ㅇ': '으', 'ㅈ': '즈', 'ㅊ': '츠', 'ㅋ': '크', 'ㅌ': '트',
  'ㅍ': '프', 'ㅎ': '흐',
};

// 기초 발음: 모음 소리 매핑 (ㅇ+모음 형태의 음절 발음)
export const VOWEL_PHONEMES: Record<string, string> = {
  'ㅏ': '아', 'ㅑ': '야', 'ㅓ': '어', 'ㅕ': '여', 'ㅗ': '오',
  'ㅛ': '요', 'ㅜ': '우', 'ㅠ': '유', 'ㅡ': '으', 'ㅣ': '이',
};
