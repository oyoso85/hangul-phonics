...
import { ALL_CONSONANTS, ALL_VOWELS, BATCHIM_CONSONANTS, composeHangul } from '../../utils/hangul';
        ...
        <div className="w-32 h-32 rounded-3xl bg-white shadow-lg flex items-center justify-center border-4 border-purple-200">
          {composed ? (
            <button
              ...
              className="text-7xl font-bold text-purple-600 hover:scale-110 transition-transform active:scale-95"
            >
              {composed}
            </button>
          ) : (
